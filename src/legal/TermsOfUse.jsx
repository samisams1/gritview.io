...
const TermsOfUse = () => {
  return (
    <div>
      <p>Effective as of January 28, 2021.</p>
      <p>
        By using Gritview.io sites, services, and mobile applications (together,
        Gritview.io), whether as a guest or a registered user, you accept and
        agree to bound by these Terms. Please read these Terms carefully before
        you start to use Gritview.io, as well as the Gritview.io Privacy Policy.
        If you do not agree to these Terms or the Gritview.io Privacy Policy you
        must not access or use Gritview.io.
      </p>
      <h5>Changes to the Terms</h5>
      <p>
        Gritview.io a platform/site owned and operated by Aevue LLC
        (“Gritview.io”, “company”, “we” or “us”). We may revise and update these
        Terms from time to time at our sole discretion. Any changes are
        effective when we post them. Your continued use of Gritview.io following
      ...
      <ul>
        ...
        <li>
          ...
          Gritview.io or interfere with any other person’s use of Gritview.io;
        </li>
        <li>
        ...
        <li>
          to attack Gritview.io via a denial-of-service attack or a distributed
      ...
      <ul>
        ...
        <li>
          ...
          Gritview.io or any other person or entity, if this is not the case.
        </li>
        <li>
      ...
      <p>
        ...
        <a href={() => false}>admin@gritview.io</a>.
      </p>
      ...
      <p>
        ...
        copyright agent at Gritview.io:
      </p>
      <ul>
      ...
      <p>
        ...
        to <a href={() => false}>admin@gritview.io</a>.
      </p>
      <p>
      ...
      <p>
        ...
        POLICY AT{" "}
        <a href="https://gritview.io/privacy">https://gritview.io/privacy</a>{" "}
      ...
      <p>
        ...
        communications relating to Gritview.io should be directed to Gritview.io
        via email: <a href={() => false}>admin@gritview.io</a>
      </p>
    </div>
  );
};
